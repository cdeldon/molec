...
/**
 * @brief Return the normalizing vector of 2 cells
 *
 ...
 */
Real* get_normal_vec(int cell_nr_1,int cell_nr_2);
 ...
 */
Real* get_normal_vec(int idx_x,int idx_y,int idx_z,int n_idx_x,int n_idx_y,int n_idx_z);
